...
export default class ExplorationScene extends Phaser.Scene {
    constructor() {
        ...
        Object.defineProperty(this, "tallyTexts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
        ...
        Object.defineProperty(this, "overlapFrameCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "lastOverlapLog", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
        });
        Object.defineProperty(this, "previousCellStates", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
            ...
            if (entity.moveTimer >= this.moveInterval) {
                ...
                if (entity.currentColor !== 0x00ff00) {
                    ...
                    if (move) {
                        ...
                        const occupiedByDying = this.entities.some(e => e.x === move.x && e.y === move.y && e.isDying);
    ...
    spawnFullyGrownEntity(growing) {
        ...
        const isOccupied = this.playerGridX === growing.x && this.playerGridY === growing.y ||
